...
set(BOOT_STORAGE core/storage/block.c core/storage/partition.c core/storage/fs.c
    core/grub/compat.c ${BOOT_GRUB_FS})
...
if(BOOT_TARGET STREQUAL "host")
    ...
    add_executable(boot-grub-compat-test tests/grub_compat_test.c core/grub/compat.c
        core/grub/arena.c core/storage/block.c)
    ...
    foreach(t boot-storage-test boot-storage-read boot-storage-fuzz boot-grub-compat-test)
        target_include_directories(${t} PRIVATE core/grub/include vendor/grub/include)
    endforeach()
    if(BOOT_SANITIZERS)
        foreach(t boot-storage-test boot-storage-read boot-storage-fuzz boot-efi-storage-test boot-grub-compat-test)
